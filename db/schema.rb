...
ActiveRecord::Schema.define(version: 2022_02_02_114100) do
  ...
  create_table "followed_relationships", force: :cascade do |t|
    ...
    t.index ["followed_user_id"], name: "index_followed_relationships_on_followed_user_id"
    t.index ["follower_id", "followed_user_id"], name: "follow_indexes", unique: true
    t.index ["follower_id"], name: "index_followed_relationships_on_follower_id"
  end
  ...
  create_table "shouts", force: :cascade do |t|
    ...
    t.bigint "shoutable_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["shoutable_type", "shoutable_id"], name: "index_shouts_on_shoutable"
